...
For more commands, please refer to file `run-yaml-cmd.md`. Please note that the `run-yaml-cmd.md` file is generated by the `gen-run-yaml-file.py` file. Refer to the `gen-run-yaml-file.py` to generate different commands for your own experiments.
...
- [Attack of the Tails: Yes, You Really Can Backdoor Federated Learning](https://arxiv.org/pdf/2006.12557.pdf)
